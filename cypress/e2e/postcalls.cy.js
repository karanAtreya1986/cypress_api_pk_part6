describe("api testing", ()=>{
    ...
    it("Appraoch2- Dynamically generating json object", ()=>{
            const requestBody={   
                ...
                //to string - we can pass how many chars needed.
    ...
    it.only("Approach3- using Fixture", ()=>{
            ...
            cy.fixture('tourist').then( (data)=>{
             ...
             cy.request( 
                ...
                method: 'POST',
                url: 'http://restapi.adequateshop.com/api/Tourist' ,
                //this needed when your website is blocked for launch by
                //click on this to verify if your human.
                ...
                .then( (response) =>{
                    ...
                    //validate property name and its value.
                    //two ways to use it.
